...
<head>
    ...
    @vite(['resources/js/app.js', 'esources/sass/app.scss'])
</head>
                        ...
                        @if (Auth::user()->hasRole('admin'))
                            ...
                            <li>
                                <a href="{{ route('user.index') }}"
                                    class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent">Manage Users</a>
                            </li>
                            <li>
                                <a href="{{ route('service.index') }}"
                                    class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent">Manage Services</a>
                            </li>
